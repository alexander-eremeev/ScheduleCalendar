...
import com.childmathematics.android.shiftschedule.presentation.ui.countries.CountriesPage
...
@Composable
fun CountriesPageScreen(
//internal fun CountriesPageScreen(
    modifier: Modifier = Modifier,
    onBackClick: () -> Unit,
    onOpenDrawer: Boolean,
    openDrawer: () -> Unit,
//    navigateToCountriesYearPage: () -> Unit,
//    state: CalendarState<DynamicSelectionState>,

    /*
    navigateToHelpCountriesPage: () -> Unit,
    navigateToHelpGraphicsPage: () -> Unit,
    navigateToHelpAboutPage: () -> Unit
     */
    countriesViewModel: CountriesViewModel
    //           viewModel: CountriesPageViewModel = viewModel(factory = AppViewModelProvider.Factory)
) {
    /*
...
//        confirmSelectionChange = viewModel::onSelectionChanged, //SelectionMode
  ...
  */
        //      val countries01PageUiState by viewModel.countries01PageUiState.collectAsState()
//        val countries01PageUiState by countries01PageViewModel.countries01PageUiState.collectAsStateWithLifecycle()
//        val countriesUiState by countriesViewModel.collectAsState()
        /*
        ...
        Scaffold(
            ...
            topBar = {
                CountriesPageTopAppBar(
                    onOpenDrawer,
                    openDrawer,
                    onBackClick,scrollBehavior,
//                   navigateToCountriesYearPage = navigateToCountriesYearPage,
                )
            },
            content ={ padding ->
                Column(
                    ...
                    CountriesPage(countriesViewModel)
                }
            },
        )
    }
...
private fun CountriesPageTopAppBar(
    onOpenDrawer: Boolean,
    openDrawer: () -> Unit,
    onBackClick: () -> Unit,
...
//    navigateToCountriesYearPage: () -> Unit,
    ...
    CenterAlignedTopAppBar(
        title = {
            Text(text = stringResource(R.string.countries_titleshort))
        },
        navigationIcon = {
            if(onOpenDrawer) {
...
/*
@Composable
private fun CountriesPageMenu(
    navigateToCountriesYearPage: () -> Unit,
) {
    CountriesPageTopAppBarDropdownMenu(
        iconContent = {
            Icon(
                Icons.Default.MoreVert,
                stringResource(id = R.string.countries_MonthSelectedDays)
            )
        }
    )
...
//            leadingIcon = {Icon(imageVector = Icons.AutoMirrored.Filled.ViewList, contentDescription = null)}
            ...
            ,
            onClick = {
                navigateToCountriesYearPage()
                closeMenu()
            },
            text = { Text(text = stringResource(id = R.string.countries_MonthSelectedDays)) }
        )
        /*
        DropdownMenuItem(
...
//-----------------------------
@Composable
private fun CountriesPageTopAppBarDropdownMenu(
