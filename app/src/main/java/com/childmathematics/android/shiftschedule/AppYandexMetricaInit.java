...
//public class AppYandexMetricaInit extends MultiDexApplication  {
    String API_KEY = "9331269b-d88b-49f2-811d-feecc9d4cec3";
    private static final String YANDEX_MOBILE_ADS_TAG = "Yandex Mobile Ads";
    private static final String YANDEX_METRIC_TAG = "Yandex Metric";
    @Override
        ...
        if (BuildConfig.YaAdsEnable) {
            ...
            MobileAds.initialize(this, new InitializationListener() {
                ...
                public void onInitializationCompleted() {
                        Log.d(YANDEX_MOBILE_ADS_TAG, "AppYandexMetricaInit: Mobile ADS SDK initialized");
                }
            });
