...
object Schedule01Destination : NavigationDestination {
    override val route = "Schedule01"
...
@Composable
fun Schedule01Screen(
    navigateToItemEntry: () -> Unit,
    navigateToItemUpdate: (Int) -> Unit,
    modifier: Modifier = Modifier,
    viewModel: Schedule01ViewModel = viewModel(factory = AppViewModelProvider.Factory)
) {
           /*
            ...
            */
    val schedule01UiState by viewModel.schedule01UiState.collectAsState()
        /*
    ...
    Scaffold(
        ...
        topBar = {
            PagesTopAppBar(
                title = stringResource(Schedule01Destination.titleRes),
        ...
        /*
        Schedule01Body(
            itemList = schedule01UiState.itemList,
