...
@Composable
internal fun HelpGraphicsScreen(
        ...
        Scaffold(
            ...
            content ={ padding ->
                Column(
                    ...
                    WebViewMainScreen("file:///android_asset/helpSchedule.html")
                    }
            },
        )
    }
...
@Composable
@OptIn(ExperimentalMaterial3Api::class)
private fun HelpGraphicsTopAppBar(
                onBackClick: () -> Unit,
                scrollBehavior: TopAppBarScrollBehavior,
) {
    CenterAlignedTopAppBar(
        title = {
            Text(text = stringResource(R.string.help_Graphics))
        },
        navigationIcon = {
